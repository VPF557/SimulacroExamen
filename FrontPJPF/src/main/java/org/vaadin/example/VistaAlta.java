...
public class VistaAlta extends VerticalLayout {
    ArrayList<Params> listaParametros = new ArrayList<>();
    public VistaAlta()
    {
    ...
    public void mostrar()
    {
        ...
        Label etiqueta1 = new Label("Entity");
        TextField texto1 = new TextField();
        Label etiqueta2 = new Label("id");
...
//Corregido y hecho
        boton.addClickListener(new ComponentEventListener<ClickEvent<Button>>() {
            ...
            public void onComponentEvent(ClickEvent<Button> event) {
                ...
                Params objeto = new Params(texto1.getValue(),Integer.parseInt(texto2.getValue()));
